	...
	public function customize_admin_toolbar () {
		...
		if (current_user_can('publish_posts')) {
			$wp_admin_bar->add_menu(array(
				'id' => 'krc_toolbar_cast',
				'title' => '在席キャスト管理',
				'href' => admin_url() . 'edit.php?post_type=krc_cast'
			));
			$wp_admin_bar->add_menu(array(
			...
			$wp_admin_bar->add_menu(array(
				...
				'title' => 'キャスト新規登録',
				'href' => admin_url() . 'post-new.php?post_type=krc_cast',
				'parent' => 'krc_toolbar_cast'
			));
			$wp_admin_bar->add_menu(array(
				'id' => 'krc_toolbar_schedule',
				'title' => 'スケジュール管理',
				'href' => admin_url() . 'edit.php?post_type=krc_cast&page=cast-schedule-krc_cast',
				'parent' => 'krc_toolbar_cast'
			));
			$wp_admin_bar->add_menu(array(
				'id' => 'krc_toolbar_order',
				'title' => '表示順管理',
				'href' => admin_url() . 'edit.php?post_type=krc_cast&page=order-post-types-krc_cast',
				'parent' => 'krc_toolbar_cast'
			));
			$wp_admin_bar->add_menu(array(
